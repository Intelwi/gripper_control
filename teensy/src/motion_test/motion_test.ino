...
// Set Port baudrate to 9600bps. This has to match with DYNAMIXEL baudrate. Why does it have to match?
int serial_bps = 9600;
...
void gripper_action(int desired_action[])
{
  ...
  // Why are these variables declared/redefined here in this manner?
  k=0;
